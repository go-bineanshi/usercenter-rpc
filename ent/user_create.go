...
func (uc *UserCreate) SetAvater(s string) *UserCreate {
	uc.mutation.SetAvater(s)
	return uc
}

// SetNillableAvater sets the "avater" field if the given value is not nil.
func (uc *UserCreate) SetNillableAvater(s *string) *UserCreate {
	if s != nil {
		uc.SetAvater(*s)
	}
	return uc
...
func (uc *UserCreate) AddAuthIDs(ids ...uint64) *UserCreate {
	uc.mutation.AddAuthIDs(ids...)
	return uc
}

// AddAuths adds the "auths" edges to the UserAuth entity.
func (uc *UserCreate) AddAuths(u ...*UserAuth) *UserCreate {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.Avater(); ok {
