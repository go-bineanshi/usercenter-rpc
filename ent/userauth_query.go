...
func (uaq *UserAuthQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (uaq *UserAuthQuery) FirstIDX(ctx context.Context) uint64 {
...
func (uaq *UserAuthQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (uaq *UserAuthQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (uaq *UserAuthQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (uaq *UserAuthQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := uaq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(userauth.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.UserAuth.Query().
//		Select(userauth.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (uaq *UserAuthQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*UserAuth, init func(*UserAuth), assign func(*UserAuth, *User)) error {
	...
	nodeids := make(map[uint64][]*UserAuth)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (uaq *UserAuthQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(userauth.Table, userauth.Columns, sqlgraph.NewFieldSpec(userauth.FieldID, field.TypeUint64))
	_spec.From = uaq.sql
